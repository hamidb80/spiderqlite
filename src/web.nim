...
var queryStrategies: QueryStrategies
...
when isMainModule:
  ...
  queryStrategies = parseQueryStrategies ctx.tomlConf

  echo "running in " & config.url
  serve server, config.server.port, config.server.host
